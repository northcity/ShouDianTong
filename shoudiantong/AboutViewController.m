...
//        [cell.contentView.layer insertSublayer:subLayerIcon below:imageViewPingGuo.layer];
    ...
    if (indexPath.row == 4) {
        UIButton *Button = [UIButton buttonWithType:UIButtonTypeCustom];
        Button = [self CellContentViewwWithBtnNormalString:@"去评价" WithBtnSelectedString:@"获取" WithAppUrlSecheme:@"chenxishoudiantong://" WithImageName:@"iconshoudiantong.png" WithTitleString:@"Version:1.0" WithDetailString:@"一款极简手电筒" WithCell:cell];
...
//    else
//    {
        NSString * url = [NSString stringWithFormat:@"itms-apps://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?type=Purple+Software&id=%@",@"1358074351"];
